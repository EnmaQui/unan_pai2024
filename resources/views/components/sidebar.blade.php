...
<aside id="logo-sidebar" class="no-print fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   ...
   <a href="{{ url()->previous() }}" class="mt-5 w-full flex justify-center" >
      ...
      <li>
            <a href="{{route('home.estudiante')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
         ...
         <li>
            <a href="{{ route('empleados.index', ['empresa_id' => $empresa->id])  }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
         ...
         <li>
            <a href="{{ route('indemnizacion.calculo', ['empresa_id' => $empresa->id])  }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">indemnizacion</span>
            </a>
         </li>
         <li>
            <a href="{{route('nominas.index', ['empresa_id' => $empresa->id])}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
         ...
         <li>
            <a href="{{route('arqueoCaja.index', ['empresa_id' => $empresa->id])}}">
               Arqueo Caja
            </a>
         </li>
